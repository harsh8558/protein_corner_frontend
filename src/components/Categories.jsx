...
const Categories = () =>{
return(<>
    <div className="w-full h-full pb-[5%] bg-white pl-[2%] pr-[2%] md:pl-[5%] pt-[3%]">
        ...
        <div className="grid md:grid-cols-5 grid-cols-3  gap-[3%] md:gap-10 mt-5 md:mt-10  md:text-lg text-[10px] font-semibold md:pl-[2%]">
            <CategoriesCard imgUrl="https://res.cloudinary.com/dxmu1ohyk/image/upload/v1737969321/removed-background_zlwg5p.png" category="Protein" navLink="/protein"/>
